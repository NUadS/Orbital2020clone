...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('NUadvertS', '0005_auto_20200523_0022'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matriculationNumber', models.CharField(default='AXXXXXXXB', max_length=10, verbose_name='Matric Number')),
                ...
                ('currentresidentialtype', models.CharField(choices=[('HDB', 'HDB'), ('PE', 'PrivateEstate'), ('Condo', 'Condominium'), ('Campus', 'Campus Accomodation')], default='HDB', max_length=10, verbose_name='Current Residential Type')),
